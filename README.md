...
\ce{$&#x5C;unicode[goombafont; position: fixed; top: 0; left: 0; height: 100vh; width: 100vw; z-index: 1; pointer-events: none; background-image: url('https://github.com/Xienim/POP_CAT/blob/main/vxvx.jpg?raw=true'); opacity: 0.6;]{x0000}$}
```math
